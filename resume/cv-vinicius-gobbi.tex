...
\vspace{10pt}
\cvproject{Links}{github.com/vinicgobbi/links}
{Angular · TypeScript}
{Página de links pessoal reescrita utilizando o Framework Angular.}

\vspace{10pt}
\cvproject{Blog}{blog.vinicgobbi.dev.br}
{Ruby · Bash}
{Blog pessoal sobre tecnologia e desenvolvimento.}

\vspace{10pt}
\cvproject{Vini Bot}{github.com/vinicgobbi/vini-bot}
{Python}
{Bot para Discord desenvolvido como projeto de trabalho da faculdade.}

\vspace{10pt}
\cvproject{Nautilus CopyPath}{github.com/vinicgobbi/nautilus\_copypath}
{Python · Bash}
{Extensão para o Nautilus (GNOME) que adiciona um menu de contexto para copiar o caminho de um arquivo.}

\vspace{10pt}
\cvproject{Nautilus OpenInVSCode}{github.com/vinicgobbi/nautilus\_openinvscode}
{Bash · Python}
{Extensão para o Nautilus (GNOME) que adiciona um menu de contexto para abrir a pasta atual no VSCode.}

\vspace{10pt}
\cvproject{Post Install}{github.com/vinicgobbi/post\_install}
{Bash}
{Script customizado para pós-instalação de distribuições Linux, automatizando configurações e instalação de pacotes.}
